    ...
    >
      <div className="w-full max-w-sm animate-scale-in">
        ...
        <div className="bg-dark-800 rounded-2xl border border-dark-700/60 shadow-2xl shadow-black/60 overflow-hidden">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl
                           ...
                           disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100"
                style={{ backgroundColor: '#1877F2', boxShadow: '0 1px 8px 0 rgba(24,119,242,0.25)' }}
              >
                <span className="flex items-center justify-center w-5 h-5">
                  {isLoading ? <Spinner /> : <FacebookIcon />}
                </span>
          ...
          {/* Footer */}
          <div className="px-8 py-4 border-t border-dark-700/60 bg-dark-900/30">
            <p className="text-center text-dark-500 text-xs leading-relaxed">
              Demo only — no real accounts or data are stored.
            </p>
          </div>
